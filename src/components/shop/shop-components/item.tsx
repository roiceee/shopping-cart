...
function ItemCard({ itemObj, setModalShow, setCurrentItem }: ItemProps) {
  ...
  return (
    <Card style={{ width: "10rem" }} className="p-1" onClick={handleItemCardClick}>
      ...
      <Card.Body className="d-flex align-items-end p-2">
        <Row>
          ...
          <Card.Text className="my-0" style={{color: "darkorange", fontSize: "1.05rem"}}>₱{itemObj.price}</Card.Text>
